<template>
  <ControlWrapper v-if="viewableLinks.length > 0" :control="control" :index="index">
    <IconPageLinkViewer :control="control" :links="viewableLinks" @click="onLinkClicked"></IconPageLinkViewer>
  </ControlWrapper>
</template>

<script>
import IconPageLinkViewer from '@/common/components/IconPageLinkViewer';
