<template>
  <div :class="$style.wrapper">
    ...
    <template v-if="value.segmentType !== 'SUBMIT_COUNT_SUM'">
      <div class="singleLineTitle marginTop10">目标控件</div>
    ...
    <el-checkbox v-model="value.showLabels"
    ...
    <el-checkbox v-model="value.showValue" class="marginBottom10 block"
                 size="mini"
                 title="显示每项数值">
      显示数值
    </el-checkbox>

    <el-checkbox v-model="value.showPercentage"
                 class="marginBottom10 block"
                 size="mini"
                 title="显示每项百分比">
      显示百分比
    ...
    <el-checkbox v-model="value.showCenterTotal"
                 class="marginBottom10 block"
                 size="mini"
                 title="在圆环图中央显示各项相加总数">
      显示总数
    </el-checkbox>
    ...
    <template v-if="refBasedControlType !== 'POINT_CHECK' && refBasedControlType !== 'ITEM_STATUS'">
      <div class="singleLineTitle marginTop10">区域颜色：</div>
      <MryColorPicker v-for="index in value.max"
                      :key="index"
