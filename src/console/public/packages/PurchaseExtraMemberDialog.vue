  ...
  <el-dialog :append-to-body="true"
    ...
    <section :class="$style.section">
      ...
      <div :class="$style.sectionParagragh">
        增购成员价格为<span :class="$style.importantText">200元/名</span>，所增购的成员数量长期有效，与套餐的有效期无关。 只有付费版套餐才能增购成员。
      </div>
    </section>

    <section :class="$style.section">
      <div :class="$style.sectionTitle">请选择购买成员数量：</div>
    ...
    <section v-if="price" :class="$style.section">
      ...
      <div :class="$style.priceItem">
        <span :class="$style.priceItemTitle">{{ `增购成员${this.amount}名：` }}</span>
